...
def train(initial,data,val,joint,seed=0):
 torch.manual_seed(seed);base=copy.deepcopy(initial);adapter=Adapter(64).to(next(base.parameters()).device) if joint else None
